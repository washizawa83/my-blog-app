...
const h1Config = `prose-h1:text-5xl prose-h1:text-center`
const h2Config = `prose-h2:text-3xl`
const h3Config = `prose-h3:text-2xl`
const h4Config = `prose-h4:text-xl`
const h5Config = `prose-h5:text-lg`
const h6Config = `prose-h6:text-l`

const headingConfig = `prose-headings:text-slate-300 prose-headings:font-normal prose-headings:my-12 prose-headings:pb-2 ${h1Config} ${h2Config} ${h3Config} ${h4Config} ${h5Config} ${h6Config}`
